...
KNOWN_ENDPOINTS = {
    "image": "https://sa-demo-region1.app.qa-pcd.platform9.com/glance/v2/images",
    "network": "https://sa-demo-region1.app.qa-pcd.platform9.com/neutron/v2.0/networks",
    "loadbalancer": "https://sa-demo-region1.app.qa-pcd.platform9.com/octavia/v2.0/lbaas/loadbalancers",
    "subnet": "https://sa-demo-region1.app.qa-pcd.platform9.com/neutron/v2.0/subnets",
    "security_group": "https://sa-demo-region1.app.qa-pcd.platform9.com/neutron/v2.0/security-groups",
    "flavor": "https://sa-demo-region1.app.qa-pcd.platform9.com/nova/v2.1/flavors",
    "volume_type": "https://sa-demo-region1.app.qa-pcd.platform9.com/cinder/v3/types",
    "user": "https://sa-demo.app.qa-pcd.platform9.com/keystone/v3/users",
    "keypair": "https://sa-demo-region1.app.qa-pcd.platform9.com/nova/v2.1/os-keypairs",
    "port": "https://sa-demo-region1.app.qa-pcd.platform9.com/neutron/v2.0/ports",
    "host": "https://sa-demo-region1.app.qa-pcd.platform9.com/nova/v2.1/os-hosts",
    "volume_image_metadata": "https://sa-demo-region1.app.qa-pcd.platform9.com/cinder/v3/volumes",
    "server_group": "https://sa-demo-region1.app.qa-pcd.platform9.com/nova/v2.1/os-server-groups",
    "hypervisor": "https://sa-demo-region1.app.qa-pcd.platform9.com/nova/v2.1/os-hypervisors",
    "backend": "https://sa-demo-region1.app.qa-pcd.platform9.com/cinder/v3/backends",
    "project": "https://sa-demo.app.qa-pcd.platform9.com/keystone/v3/projects",
    "host_config": "https://sa-demo-region1.app.qa-pcd.platform9.com/nova/v2.1/os-host-configs",
    "cluster_blueprint": "https://sa-demo-region1.app.qa-pcd.platform9.com/cluster/v1/blueprints",
}
